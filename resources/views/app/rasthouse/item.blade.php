    ...
    <div class="pt-br">
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1><i class="fas fa-fw fa-plane-arrival"></i> House</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{ route('app.home') }}">Home</a></li>
                            <li class="breadcrumb-item"><a href="{{ route('app.rastHouse') }}">House</a></li>
                            <li class="breadcrumb-item active">Item de House</li>
                        </ol>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-footer">
                                <a href="{{ route('app.rastHouse') }}" class="btn btn-primary">Retornar para House</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{ route('app.home') }}">Home</a></li>
                            <li class="breadcrumb-item"><a href="{{ route('app.rastHouse') }}">House</a></li>
                            <li class="breadcrumb-item active">House Item</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-footer">
                                <a href="{{ route('app.rastHouse') }}" class="btn btn-primary">Return to House</a>
                            </div>
                        </div>
                    </div>
                </div>
